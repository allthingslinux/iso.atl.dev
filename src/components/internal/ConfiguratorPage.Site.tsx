...
export default function SiteForm({ form, onResetField }: FormProps) {
  return (
    ...
    >
        ...
        <FormField
          ...
          render={({ field, fieldState }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="My Awesome Index" {...field} />
              </FormControl>
        ...
        <FormField
          ...
          render={({ field, fieldState }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="%s - %t" {...field} />
              </FormControl>
              <FormDescription>
                Template for the site name.{" "}
                <code className="font-semibold">%t</code> for site name and{" "}
        ...
        <FormField
          ...
          render={({ field, fieldState }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="mbaharip" {...field} />
              </FormControl>
              <FormDescription>
                Site author to be displayed on the metadata, and used for the
                footer.
              </FormDescription>
              <FormMessage />
            </FormItem>
        ...
        <FormField
          ...
          render={({ field, fieldState }) => (
            <FormItem>
              ...
              <FormDescription>
                X (Twitter) handle to be used on the metadata, and for the
                footer.
              </FormDescription>
              <FormMessage />
            </FormItem>
      ...
      <NavbarItemsField form={form} onResetField={onResetField} />
      <SupportsField form={form} onResetField={onResetField} />
      <FooterField form={form} onResetField={onResetField} />
    </FormSection>
  );
}
...
function NavbarItemsField({ form, onResetField }: FormProps) {
  ...
  const { append, fields, remove } = useFieldArray<
    z.infer<typeof Schema_App_Configuration>
  >({
    control: form.control,
      ...
      IconNamesArray.map((icon) => ({
        label: (
          <div className="inline-flex grow items-center justify-between gap-2">
            ...
            <Icon name={icon} hideWrapper className="shrink-0" />
          </div>
        ),
        value: icon,
      })),
        ...
        <div className="space-y-2">
          <div className="flex w-full items-center justify-between gap-2 tablet:w-fit tablet:justify-start">
            ...
            <Button
              ...
              size={"icon"}
            >
              <Icon name="RefreshCcw" className="stroke-inherit" />
            </Button>
          </div>
          {fields.length === 0 ? (
                ...
                <div className="flex flex-col gap-4" key={field.id}>
                  <div className="flex w-full flex-col gap-4 tablet:flex-row tablet:items-end">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem disableBorder className="grow">
                          <FormLabel>Name</FormLabel>
                          <FormControl>
                            <Input placeholder="Navigation name" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
  ...
  const templates = useMemo(
    () => [
      ...
      },
      {
        code: "poweredBy",
        description:
          'Show "Powered by next-gdrive-index", linked to the repository',
      },
      {
        code: "year",
                    ...
                    <FormItem disableBorder>
                      ...
                      >
                        <span className="flex flex-col gap-2 tablet:flex-row tablet:items-center tablet:justify-between">
                          <span>
                            Text to be displayed on the footer.{" "}
            ...
            <div className="flex w-full flex-col items-center justify-center">
              <div className="flex w-full select-none flex-col items-center justify-center text-center">
                <ReactMarkdown
                  components={{
                    p: ({ children, ...props }) => (
                      <p {...props} className="muted text-balance text-sm">
                        {children}
                      </p>
                    ),
                    a: ({ children, ...props }) => {
