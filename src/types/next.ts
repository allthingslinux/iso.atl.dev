...
export class TypedResponse<T = any> extends Response {
...
export type SearchParams<T extends Record<string, string | string[] | undefined>> = T

// Async component type
export type AsyncComponent<P = {}> = (props: P) => Promise<ReactElement> | ReactElement
