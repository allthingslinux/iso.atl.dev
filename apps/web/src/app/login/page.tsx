      ...
      <div className={cn("flex flex-col gap-6 w-full max-w-sm")}>
        <Card className="border-zinc-800 bg-zinc-900/50">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-xl text-white">Welcome to ISO Archive</CardTitle>
          ...
          <CardContent className="space-y-4">
            <Button
              variant="outline"
              className="w-full gap-2 border-zinc-700 bg-zinc-800/50 hover:bg-zinc-800"
